...
class make_dental_appointment_invoice(osv.osv_memory):
	_name="dental.appointment.invoice"

	def create_invoice(self, cr, uid, ids, context={}):
		invoice_obj = self.pool.get('account.invoice')
		appointment_obj = self.pool.get('dental.appointment')
...
make_dental_appointment_invoice()
